    ...
    public static function retrievePosts() {
     ...
     //retrieve posts by a particular user
       public static function retrieveUserPosts() {
        ...
        // $data = queryDb('SELECT * FROM posts');   
        // foreach($data as $result) {
        // print_r($result);
        //where do i put the html i'm pulling from bootstrap to 

        //prepare query = get * posts where userId = x;
        //execute query
        //return posts
}
//retrieve posts
//single post: public static function getById($id) 
//multiple posts
